...
const test_case = {
    ...
    15: new Post(
        ...
        'comment',
        1,
        new Content('0x80mem',false,'C++主要用于游戏领域、办公软件、图形处理、网站搜索引擎、图形界面层关系型数据库、浏览器、软件开发、集成环境、ide等等，太多了，目前找工作机会仅次于Java。'),
        [7],
        [],
    ),
    16: new Post(
        ...
        'comment',
        1,
        new Content('0x80mem',false,'第二个评论哟'),
        [7],
        [],
    ),
    17: new Post(
